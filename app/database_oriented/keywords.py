...
KW_USER_DATE_OF_BIRTH = "datum_narodenia"
...
KW_LIST_USER = [KW_USER_NAME, KW_USER_SURNAME, KW_USER_EMAIL, KW_USER_HASHED_PASSWORD, KW_USER_ROLE_ID,
                KW_USER_RIGHTS, KW_USER_SEX, KW_USER_DATE_OF_BIRTH]
KW_LIST_PATIENT = [KW_PATIENT_MEDIC_ID, KW_PATIENT_USER_ID, KW_PATIENT_NOTE_MEDIC,
                   KW_PATIENT_DIAGNOSIS]
KW_LIST_IMAGE = [KW_IMAGE_PATIENT_ID, KW_IMAGE_DEVICE_ID, KW_IMAGE_ADD_DEVICE_ID, KW_IMAGE_PATH, KW_IMAGE_QUALITY,
